...
def build_model(embedding_layer):
    ...
    print('after Pool question  shape', np.shape(question))
    ...
    print('after flatten shape', np.shape(question))
    ...
    print('merged', np.shape(merged))
    preds = layers.Dense(10, activation='sigmoid', name="activation")(merged)
    preds = layers.Dense(1, activation='sigmoid')(preds)
